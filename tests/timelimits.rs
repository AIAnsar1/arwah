...
fn run_arwah_with_timeout(args: &[&str], timeout: Duration) {
    println!("Running: target/debug/arwah: {}", args.join(" "));
...
mod timelimits {
    ...
    fn scan_localhost() {
        ...
        super::run_arwah_with_timeout(&["--greppable", "--no-nmap", "127.0.0.1"], timeout);
    }
    ...
    fn udp_scan_localhost() {
        let timeout = super::Duration::from_secs(25);
        super::run_arwah_with_timeout(&["--greppable", "127.0.0.1", "--udp"], timeout);
    }
    #[test]
    #[ignore]
